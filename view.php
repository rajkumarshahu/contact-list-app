...
if(isset($_GET['id']) && $_GET['id']>0) {
    ...
    <section class="container" >
        ...
        <table class="table  table-bordered table-striped table-hover ">
            <tr><td colspan="3" align="center"><img  src="images/pictures/<?php echo $user_info['picture'];?>" width="300" /></td></tr>
...
<a href="folder_view/vs.php?s=<?php echo __FILE__?>&pagename=view.php" target="_blank">View Source</a>
</h3>